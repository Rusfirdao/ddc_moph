                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="our_solution_category ">
                        <div class="solution_cards_box">
                            <div class="solution_card" onclick="location.href='./pages/dashboard.php'">
                                ...
                                <div class="solu_title">
                                    <h3>รถตรวจชีวะนิรภัย </h3>
                                </div>
                            </div>
                            <!-- end card 1-->
                            <div class="solution_card" onclick="location.href='./pages/dashboard1.php'">
                                <div class="hover_color_bubble"></div>
                                <div class="so_top_icon">
                                    <svg id="Layer_1" enable-background="new 0 0 512 512" height="50" viewBox="0 0 512 512" width="40" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                ...
                                <div class="solu_title">
                                    <h3>โครงการราชทัณฑ์ </h3>
                                </div>
                            </div>
                            <!-- end card 2-->
                            <div class="solution_card" onclick="location.href='./pages/dashboard2.php'">
                                <div class="hover_color_bubble"></div>
                                <div class="so_top_icon">
                                    <svg id="Layer_1" enable-background="new 0 0 512 512" height="50" viewBox="0 0 512 512" width="40" xmlns="http://www.w3.org/2000/svg">
                                        <g>
...
<style>
    .bar {
        ...
        margin-bottom: 30px;
        height: 90px;
        box-shadow: 3px 3px 10px rgba(136, 144, 195, 0.2);
    }
